...
var isDev = ENV === 'test' || ENV === 'test-watch';
var isBuild = ENV === 'build' || ENV === 'test-build';
...
module.exports = function makeWebpackConfig () {
  ...
  config.module = {
    ...
    loaders: [{
      ...
      loader: isDev ? null : ExtractTextPlugin.extract('style', 'css?sourceMap!postcss')
    }, {
      // ASSET LOADER
      ...
      test: /\.(png|jpg|jpeg|gif|svg|woff|woff2|ttf|eot)(\?v=.*)?$/,
      loader: 'file'
    }, {
      // HTML LOADER
